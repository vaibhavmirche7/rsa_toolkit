RSA Web Toolkit
A browser-based workbench for RSA: generate real (or deliberately weak) key pairs, encrypt/decrypt strings and files, and run classic CTF-style attacks against weak keys. No accounts, no database everything server-side is stateless and nothing you generate is stored; the browser holds your keys/results and downloads them directly.
